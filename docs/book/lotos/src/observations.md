...
- **Task/status queues preserve no-drop semantics.** EventLoop callbacks hand off complete frame sets to owner-thread queues; task and status traffic should not silently drop under load.
